    ...
    class Cache
      module RefreshPolicy
        module Immediate
          ...
          def self.refresh(id, cache, projection_class, stream_name, entity_class, &blk)
          ...
          def self.!(id, cache, projection_class, stream_name, entity_class)
            cache_record = refresh(id, cache, projection_class, stream_name, entity_class) do |cache_record|
              unless cache_record
